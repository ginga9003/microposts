...
ActiveRecord::Schema.define(version: 20150926072116) do
  ...
  add_index "favorites", ["user_id", "favorite_id"], name: "index_favorites_on_user_id_and_favorite_id", unique: true
  ...
  add_index "retweets", ["user_id", "retweet_id"], name: "index_retweets_on_user_id_and_retweet_id", unique: true
